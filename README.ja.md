...
| プラットフォーム | ファイル | 備考 |
|------------------|----------|------|
| **Windows x64** | [tscrt_win-1.0.14-win64.exe](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_win-1.0.14-win64.exe) | NSIS インストーラー |
...
| **macOS (Universal)** | [tscrt_mac-1.0.14-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_mac-1.0.14-universal.dmg) | `tscrt_mac.app` を `/Applications` にドラッグ |
