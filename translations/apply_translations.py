...
TRANSLATIONS = {
    ...
    "&amp;Edit": {
        ...
        "it": "&amp;Modifica", "pt": "&amp;Editar", "ru": "&amp;Правка",
    },
    "&amp;Export": {
    ...
    "&lt;b&gt;The diagnostic bundle will include:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;App log (&lt;code&gt;tscrt_win.log&lt;/code&gt;): connection events, error messages&lt;/li&gt;&lt;li&gt;System info: OS, Qt / libssh2 versions, locale&lt;/li&gt;&lt;li&gt;Paths and selected environment variables (may contain your Windows username)&lt;/li&gt;&lt;li&gt;Crash dump file names (contents are NOT included)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;The bundle will NOT include:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Passwords or SSH private keys&lt;/li&gt;&lt;li&gt;Your session profile (hosts, snapshots, automation rules)&lt;/li&gt;&lt;li&gt;Snapshot files or per-session terminal capture logs&lt;/li&gt;&lt;li&gt;Commands you typed or terminal output&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;Review the generated &lt;code&gt;.txt.gz&lt;/code&gt; before sharing.&lt;/p&gt;": {
        "ko": "&lt;b&gt;진단 번들에 포함되는 항목:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;앱 로그(&lt;code&gt;tscrt_win.log&lt;/code&gt;): 접속 이벤트, 오류 메시지&lt;/li&gt;&lt;li&gt;시스템 정보: OS, Qt / libssh2 버전, 로케일&lt;/li&gt;&lt;li&gt;경로 및 일부 환경변수(Windows 사용자명이 포함될 수 있음)&lt;/li&gt;&lt;li&gt;크래시 덤프 파일 이름 (내용은 포함되지 않음)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;포함되지 않는 항목:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;비밀번호 및 SSH 개인 키&lt;/li&gt;&lt;li&gt;세션 프로파일(호스트, 스냅샷, 자동화 규칙)&lt;/li&gt;&lt;li&gt;스냅샷 파일 및 세션별 터미널 캡처 로그&lt;/li&gt;&lt;li&gt;입력한 명령 또는 터미널 출력&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;공유 전 생성된 &lt;code&gt;.txt.gz&lt;/code&gt; 파일을 확인하세요.&lt;/p&gt;",
        "ja": "&lt;b&gt;診断バンドルに含まれるもの:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;アプリログ(&lt;code&gt;tscrt_win.log&lt;/code&gt;): 接続イベント、エラーメッセージ&lt;/li&gt;&lt;li&gt;システム情報: OS、Qt / libssh2 バージョン、ロケール&lt;/li&gt;&lt;li&gt;パスおよび一部の環境変数(Windows ユーザー名が含まれる場合があります)&lt;/li&gt;&lt;li&gt;クラッシュダンプのファイル名(内容は含まれません)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;含まれないもの:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;パスワード、SSH 秘密鍵&lt;/li&gt;&lt;li&gt;セッション プロファイル(ホスト、スナップショット、自動化ルール)&lt;/li&gt;&lt;li&gt;スナップショット ファイルおよびセッションごとの端末キャプチャログ&lt;/li&gt;&lt;li&gt;入力したコマンドや端末出力&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;共有する前に、生成された &lt;code&gt;.txt.gz&lt;/code&gt; を確認してください。&lt;/p&gt;",
        "zh": "&lt;b&gt;诊断包包含:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;应用日志(&lt;code&gt;tscrt_win.log&lt;/code&gt;): 连接事件、错误信息&lt;/li&gt;&lt;li&gt;系统信息: 操作系统、Qt / libssh2 版本、区域设置&lt;/li&gt;&lt;li&gt;路径和部分环境变量(可能包含您的 Windows 用户名)&lt;/li&gt;&lt;li&gt;崩溃转储文件名(不包含内容)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;不包含:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;密码或 SSH 私钥&lt;/li&gt;&lt;li&gt;会话配置(主机、快照、自动化规则)&lt;/li&gt;&lt;li&gt;快照文件或每个会话的终端捕获日志&lt;/li&gt;&lt;li&gt;您输入的命令或终端输出&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;共享前请查看生成的 &lt;code&gt;.txt.gz&lt;/code&gt; 文件。&lt;/p&gt;",
        "de": "&lt;b&gt;Das Diagnose-Paket enthält:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;App-Log (&lt;code&gt;tscrt_win.log&lt;/code&gt;): Verbindungsereignisse, Fehlermeldungen&lt;/li&gt;&lt;li&gt;Systeminfo: OS, Qt / libssh2-Versionen, Sprache&lt;/li&gt;&lt;li&gt;Pfade und ausgewählte Umgebungsvariablen (können Ihren Windows-Benutzernamen enthalten)&lt;/li&gt;&lt;li&gt;Namen von Crash-Dump-Dateien (Inhalte werden NICHT übermittelt)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;Das Paket enthält NICHT:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Passwörter oder private SSH-Schlüssel&lt;/li&gt;&lt;li&gt;Ihr Sitzungsprofil (Hosts, Snapshots, Automatisierungsregeln)&lt;/li&gt;&lt;li&gt;Snapshot-Dateien oder sitzungsbezogene Terminal-Aufzeichnungen&lt;/li&gt;&lt;li&gt;Eingegebene Befehle oder Terminal-Ausgaben&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;Prüfen Sie die erzeugte &lt;code&gt;.txt.gz&lt;/code&gt;-Datei vor der Weitergabe.&lt;/p&gt;",
        "es": "&lt;b&gt;El paquete de diagnóstico incluirá:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Log de la aplicación (&lt;code&gt;tscrt_win.log&lt;/code&gt;): eventos de conexión, mensajes de error&lt;/li&gt;&lt;li&gt;Información del sistema: SO, versiones de Qt / libssh2, configuración regional&lt;/li&gt;&lt;li&gt;Rutas y algunas variables de entorno (pueden contener su nombre de usuario de Windows)&lt;/li&gt;&lt;li&gt;Nombres de archivos de volcado (el contenido NO se incluye)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;El paquete NO incluirá:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Contraseñas ni claves privadas SSH&lt;/li&gt;&lt;li&gt;Su perfil de sesiones (hosts, instantáneas, reglas de automatización)&lt;/li&gt;&lt;li&gt;Archivos de instantáneas ni logs de captura de terminal por sesión&lt;/li&gt;&lt;li&gt;Comandos introducidos ni la salida del terminal&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;Revise el &lt;code&gt;.txt.gz&lt;/code&gt; generado antes de compartirlo.&lt;/p&gt;",
        "fr": "&lt;b&gt;Le paquet de diagnostic contiendra :&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Journal de l'application (&lt;code&gt;tscrt_win.log&lt;/code&gt;) : événements de connexion, messages d'erreur&lt;/li&gt;&lt;li&gt;Informations système : OS, versions de Qt / libssh2, locale&lt;/li&gt;&lt;li&gt;Chemins et certaines variables d'environnement (peuvent contenir votre nom d'utilisateur Windows)&lt;/li&gt;&lt;li&gt;Noms des fichiers de crash dump (le contenu N'est PAS inclus)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;Le paquet N'inclura PAS :&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Mots de passe ou clés privées SSH&lt;/li&gt;&lt;li&gt;Votre profil de session (hôtes, instantanés, règles d'automatisation)&lt;/li&gt;&lt;li&gt;Fichiers d'instantanés ou journaux de capture du terminal par session&lt;/li&gt;&lt;li&gt;Commandes saisies ou sortie du terminal&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;Vérifiez le fichier &lt;code&gt;.txt.gz&lt;/code&gt; généré avant de le partager.&lt;/p&gt;",
        "it": "&lt;b&gt;Il pacchetto diagnostico includerà:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Log dell'app (&lt;code&gt;tscrt_win.log&lt;/code&gt;): eventi di connessione, messaggi di errore&lt;/li&gt;&lt;li&gt;Informazioni di sistema: OS, versioni di Qt / libssh2, locale&lt;/li&gt;&lt;li&gt;Percorsi e alcune variabili d'ambiente (possono contenere il nome utente Windows)&lt;/li&gt;&lt;li&gt;Nomi dei file di crash dump (i contenuti NON sono inclusi)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;Il pacchetto NON includerà:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Password o chiavi private SSH&lt;/li&gt;&lt;li&gt;Il profilo delle sessioni (host, snapshot, regole di automazione)&lt;/li&gt;&lt;li&gt;File di snapshot o log di cattura del terminale per sessione&lt;/li&gt;&lt;li&gt;Comandi digitati od output del terminale&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;Controlla il &lt;code&gt;.txt.gz&lt;/code&gt; generato prima di condividerlo.&lt;/p&gt;",
        "pt": "&lt;b&gt;O pacote de diagnóstico incluirá:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Log do aplicativo (&lt;code&gt;tscrt_win.log&lt;/code&gt;): eventos de conexão, mensagens de erro&lt;/li&gt;&lt;li&gt;Informações do sistema: SO, versões do Qt / libssh2, localidade&lt;/li&gt;&lt;li&gt;Caminhos e algumas variáveis de ambiente (podem conter seu nome de usuário do Windows)&lt;/li&gt;&lt;li&gt;Nomes de arquivos de crash dump (o conteúdo NÃO é incluído)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;O pacote NÃO incluirá:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Senhas ou chaves privadas SSH&lt;/li&gt;&lt;li&gt;Seu perfil de sessões (hosts, snapshots, regras de automação)&lt;/li&gt;&lt;li&gt;Arquivos de snapshot ou logs de captura de terminal por sessão&lt;/li&gt;&lt;li&gt;Comandos digitados ou saída do terminal&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;Revise o &lt;code&gt;.txt.gz&lt;/code&gt; gerado antes de compartilhá-lo.&lt;/p&gt;",
        "ru": "&lt;b&gt;Диагностический пакет будет содержать:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Журнал приложения (&lt;code&gt;tscrt_win.log&lt;/code&gt;): события подключения, сообщения об ошибках&lt;/li&gt;&lt;li&gt;Системная информация: ОС, версии Qt / libssh2, локаль&lt;/li&gt;&lt;li&gt;Пути и отдельные переменные среды (могут содержать имя пользователя Windows)&lt;/li&gt;&lt;li&gt;Имена файлов crash dump (их содержимое НЕ включено)&lt;/li&gt;&lt;/ul&gt;&lt;b&gt;Пакет НЕ содержит:&lt;/b&gt;&lt;ul&gt;&lt;li&gt;Пароли и закрытые ключи SSH&lt;/li&gt;&lt;li&gt;Ваш профиль сессий (хосты, снимки, правила автоматизации)&lt;/li&gt;&lt;li&gt;Файлы снимков и журналы захвата терминала по сессиям&lt;/li&gt;&lt;li&gt;Введённые команды и вывод терминала&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;Перед передачей проверьте созданный файл &lt;code&gt;.txt.gz&lt;/code&gt;.&lt;/p&gt;",
    },
    "Continue": {
        "ko": "계속", "ja": "続行", "zh": "继续",
        "de": "Weiter", "es": "Continuar", "fr": "Continuer",
    ...
    "Link Tab to Peer Tab...": {
        "ko": "다른 TSCRT의 탭과 연결...",
        "ja": "他のTSCRTのタブとリンク...",
        "zh": "与其他TSCRT的标签页连接...",
        "de": "Tab mit Peer-Tab verknüpfen...",
        "es": "Vincular pestaña con pestaña remota...",
        "fr": "Lier l'onglet à un onglet distant...",
        "it": "Collega scheda a scheda remota...",
        "pt": "Vincular aba com aba remota...",
        "ru": "Связать вкладку с удалённой вкладкой...",
    },
    "Link Tab to Peer Tab": {
        "ko": "다른 TSCRT의 탭과 연결",
        "ja": "他のTSCRTのタブとリンク",
    ...
    "Unlink Tab (currently: %1)": {
        "ko": "탭 연결 해제 (현재: %1)",
        "ja": "タブのリンク解除 (現在: %1)",
        "zh": "解除标签连接 (当前: %1)",
        "de": "Tab-Verknüpfung lösen (aktuell: %1)",
        "es": "Desvincular pestaña (actual: %1)",
        "fr": "Dissocier l'onglet (actuel : %1)",
        "it": "Scollega scheda (attuale: %1)",
        "pt": "Desvincular aba (atual: %1)",
        "ru": "Разорвать связь вкладки (текущая: %1)",
    },
    "%1 (slot %2)": {
        "ko": "%1 (슬롯 %2)",
        "ja": "%1 (スロット %2)",
    ...
    "(no other TSCRT instance detected)": {
        "ko": "(연결된 다른 TSCRT 인스턴스가 없음)",
        "ja": "(他のTSCRTインスタンスが検出されていません)",
        "zh": "(未检测到其他TSCRT实例)",
        "de": "(keine weitere TSCRT-Instanz erkannt)",
        "es": "(no se detectó otra instancia de TSCRT)",
        "fr": "(aucune autre instance TSCRT détectée)",
        "it": "(nessuna altra istanza TSCRT rilevata)",
        "pt": "(nenhuma outra instância do TSCRT detectada)",
        "ru": "(другие экземпляры TSCRT не обнаружены)",
    },
    "(no tabs)": {
        "ko": "(열린 탭 없음)",
        "ja": "(タブなし)",
    ...
    "Pick a tab": {
        ...
        "it": "Seleziona una scheda",
        "pt": "Selecionar aba",
        "ru": "Выбрать вкладку",
    },
    "Please select a specific peer tab to pair with.": {
        "ko": "연결할 상대 탭을 구체적으로 선택하세요.",
        "ja": "ペアにする相手のタブを具体的に選択してください。",
        "zh": "请选择要配对的具体对端标签页。",
        "de": "Bitte einen bestimmten Peer-Tab zum Verknüpfen auswählen.",
        "es": "Por favor, seleccione una pestaña remota específica para emparejar.",
        "fr": "Veuillez sélectionner un onglet distant spécifique pour l'association.",
        "it": "Selezionare una scheda remota specifica da associare.",
        "pt": "Por favor, selecione uma aba remota específica para parear.",
        "ru": "Пожалуйста, выберите конкретную удалённую вкладку для связи.",
    },
    "Select the exact tab in another TSCRT instance to pair with\n<b>%1 (slot %2)</b>. Switching to either tab will automatically\nactivate the other.": {
        "ko": "<b>%1 (슬롯 %2)</b>과 연결할 다른 TSCRT 인스턴스의\n특정 탭을 선택하세요. 어느 쪽 탭이든 전환하면\n다른 쪽이 자동으로 활성화됩니다.",
        "ja": "<b>%1 (スロット %2)</b>とペアにする別のTSCRTインスタンスの\n特定のタブを選択してください。どちらのタブに切り替えても\nもう一方が自動で有効化されます。",
        "zh": "请选择要与<b>%1 (槽 %2)</b>配对的另一个TSCRT实例的\n特定标签页。切换任一标签页都会自动激活另一个。",
        "de": "Wählen Sie den exakten Tab in einer anderen TSCRT-Instanz,\nder mit <b>%1 (Slot %2)</b> verknüpft werden soll. Der Wechsel\nzu einem Tab aktiviert automatisch den anderen.",
        "es": "Seleccione la pestaña exacta en otra instancia de TSCRT para emparejar\ncon <b>%1 (ranura %2)</b>. Al cambiar a cualquier pestaña se activará\nla otra automáticamente.",
        "fr": "Sélectionnez l'onglet exact dans une autre instance TSCRT pour l'associer\nà <b>%1 (emplacement %2)</b>. Changer vers l'un des onglets activera\nautomatiquement l'autre.",
        "it": "Seleziona la scheda esatta in un'altra istanza TSCRT da associare a\n<b>%1 (slot %2)</b>. Passare a una delle schede attiverà automaticamente\nl'altra.",
        "pt": "Selecione a aba exata em outra instância do TSCRT para parear com\n<b>%1 (slot %2)</b>. Alternar para qualquer aba ativará automaticamente\na outra.",
        "ru": "Выберите конкретную вкладку в другом экземпляре TSCRT для связи\nс <b>%1 (слот %2)</b>. Переключение на любую вкладку автоматически\nактивирует другую.",
    },
    "Close": {
        "ko": "닫기", "ja": "閉じる", "zh": "关闭",
    ...
    "Connecting to GitHub...": {
        ...
        "ja": "GitHub に接続中...",
        "zh": "正在连接 GitHub...",
        "de": "Verbindung zu GitHub...",
        "es": "Conectando a GitHub...",
        "fr": "Connexion à GitHub...",
        "it": "Connessione a GitHub...",
        "pt": "Conectando ao GitHub...",
        "ru": "Подключение к GitHub...",
    },
    "Update available": {
        "ko": "업데이트 가능",
        "ja": "アップデート可能",
    ...
    "A new version of TSCRT is available: <b>%1</b><br>(current: %2)<br><br>Would you like to open the download page?": {
        "ko": "새 버전 <b>%1</b> 이 있습니다.<br>(현재: %2)<br><br>다운로드 페이지를 여시겠습니까?",
        "ja": "新しいバージョン <b>%1</b> があります。<br>(現在: %2)<br><br>ダウンロードページを開きますか？",
        "zh": "有新版本 <b>%1</b> 可用。<br>(当前: %2)<br><br>是否打开下载页面？",
        "de": "Eine neue Version <b>%1</b> ist verfügbar.<br>(aktuell: %2)<br><br>Möchten Sie die Download-Seite öffnen?",
        "es": "Hay una nueva versión <b>%1</b> disponible.<br>(actual: %2)<br><br>¿Desea abrir la página de descarga?",
        "fr": "Une nouvelle version <b>%1</b> est disponible.<br>(actuelle : %2)<br><br>Voulez-vous ouvrir la page de téléchargement ?",
        "it": "È disponibile una nuova versione <b>%1</b>.<br>(attuale: %2)<br><br>Vuoi aprire la pagina di download?",
        "pt": "Uma nova versão <b>%1</b> está disponível.<br>(atual: %2)<br><br>Deseja abrir a página de download?",
        "ru": "Доступна новая версия <b>%1</b>.<br>(текущая: %2)<br><br>Открыть страницу загрузки?",
    },
    "<b>New version available: %1</b><br><a href=\"%2\">Open download page</a>": {
        "ko": "<b>새 버전: %1</b><br><a href=\"%2\">다운로드 페이지 열기</a>",
        "ja": "<b>新バージョン: %1</b><br><a href=\"%2\">ダウンロードページを開く</a>",
        "zh": "<b>新版本: %1</b><br><a href=\"%2\">打开下载页面</a>",
        "de": "<b>Neue Version: %1</b><br><a href=\"%2\">Download-Seite öffnen</a>",
        "es": "<b>Nueva versión: %1</b><br><a href=\"%2\">Abrir página de descarga</a>",
        "fr": "<b>Nouvelle version : %1</b><br><a href=\"%2\">Ouvrir la page de téléchargement</a>",
        "it": "<b>Nuova versione: %1</b><br><a href=\"%2\">Apri pagina download</a>",
        "pt": "<b>Nova versão: %1</b><br><a href=\"%2\">Abrir página de download</a>",
        "ru": "<b>Новая версия: %1</b><br><a href=\"%2\">Открыть страницу загрузки</a>",
    },
    "<span style=\"color:green;\">&#10003; You are running the latest version.</span>": {
        "ko": "<span style=\"color:green;\">&#10003; 최신 버전입니다.</span>",
        "ja": "<span style=\"color:green;\">&#10003; 最新バージョンです。</span>",
        "zh": "<span style=\"color:green;\">&#10003; 已是最新版本。</span>",
        "de": "<span style=\"color:green;\">&#10003; Sie verwenden die neueste Version.</span>",
        "es": "<span style=\"color:green;\">&#10003; Está usando la versión más reciente.</span>",
        "fr": "<span style=\"color:green;\">&#10003; Vous utilisez la dernière version.</span>",
        "it": "<span style=\"color:green;\">&#10003; Stai usando l'ultima versione.</span>",
        "pt": "<span style=\"color:green;\">&#10003; Você está usando a versão mais recente.</span>",
        "ru": "<span style=\"color:green;\">&#10003; У вас последняя версия.</span>",
    },
    "<span style=\"color:orange;\">Update check failed: %1</span>": {
        "ko": "<span style=\"color:orange;\">업데이트 확인 실패: %1</span>",
        "ja": "<span style=\"color:orange;\">更新確認失敗: %1</span>",
        "zh": "<span style=\"color:orange;\">更新检查失败: %1</span>",
        "de": "<span style=\"color:orange;\">Update-Prüfung fehlgeschlagen: %1</span>",
        "es": "<span style=\"color:orange;\">Error al comprobar actualizaciones: %1</span>",
        "fr": "<span style=\"color:orange;\">Échec de la vérification : %1</span>",
        "it": "<span style=\"color:orange;\">Controllo aggiornamenti fallito: %1</span>",
        "pt": "<span style=\"color:orange;\">Falha na verificação de atualização: %1</span>",
        "ru": "<span style=\"color:orange;\">Ошибка проверки обновления: %1</span>",
    },
    "Browse...": {
        "ko": "찾아보기...", "ja": "参照...", "zh": "浏览...",
