...
|-----------|-------|----------|
| **Windows x64** | [tscrt_win-1.0.12-win64.exe](https://github.com/nice1972/TSCRT/releases/download/v1.0.12/tscrt_win-1.0.12-win64.exe) | NSIS-Installationsprogramm |
...
| **macOS (Universal)** | [tscrt_mac-1.0.12-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.12/tscrt_mac-1.0.12-universal.dmg) | `tscrt_mac.app` in `/Applications` ziehen |
