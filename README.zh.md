...
预编译的二进制文件发布在 [GitHub Releases](https://github.com/nice1972/TSCRT/releases/latest)。

| 平台 | 文件 | 说明 |
|------|------|------|
| **Windows x64** | [tscrt_win-1.0.14-win64.exe](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_win-1.0.14-win64.exe) | NSIS 安装程序 |
...
| **macOS (Universal)** | [tscrt_mac-1.0.14-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_mac-1.0.14-universal.dmg) | 将 `tscrt_mac.app` 拖入 `/Applications` |
