...
Les binaires précompilés sont publiés sur [GitHub Releases](https://github.com/nice1972/TSCRT/releases/latest).

| Plateforme | Fichier | Notes |
|------------|---------|-------|
| **Windows x64** | [tscrt_win-1.0.14-win64.exe](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_win-1.0.14-win64.exe) | Installateur NSIS |
...
| **macOS (Universal)** | [tscrt_mac-1.0.14-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_mac-1.0.14-universal.dmg) | Glisser `tscrt_mac.app` dans `/Applications` |
