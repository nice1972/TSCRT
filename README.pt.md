...
| **macOS (Universal)** | [tscrt_mac-1.0.12-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.12/tscrt_mac-1.0.12-universal.dmg) | Arrastar `tscrt_mac.app` para `/Applications` |
