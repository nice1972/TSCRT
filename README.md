...
| Platform | File | Notes |
|----------|------|-------|
| **Windows x64** | [tscrt_win-1.0.14-win64.exe](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_win-1.0.14-win64.exe) | NSIS installer |
...
| **macOS (Universal: Apple Silicon + Intel)** | [tscrt_mac-1.0.14-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_mac-1.0.14-universal.dmg) | Drag `tscrt_mac.app` to `/Applications`. First launch: right-click → Open (unsigned). |
