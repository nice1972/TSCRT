...
| **macOS (Universal)** | [tscrt_mac-1.0.14-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.14/tscrt_mac-1.0.14-universal.dmg) | Arrastrar `tscrt_mac.app` a `/Applications` |
