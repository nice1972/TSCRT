...
| 플랫폼 | 파일 | 비고 |
|--------|------|------|
| **Windows x64** | [tscrt_win-1.0.12-win64.exe](https://github.com/nice1972/TSCRT/releases/download/v1.0.12/tscrt_win-1.0.12-win64.exe) | NSIS 설치 관리자 |
...
| **macOS (Universal: Apple Silicon + Intel)** | [tscrt_mac-1.0.12-universal.dmg](https://github.com/nice1972/TSCRT/releases/download/v1.0.12/tscrt_mac-1.0.12-universal.dmg) | `tscrt_mac.app` 을 `/Applications` 으로 끌어 놓기. 첫 실행: 우클릭 → 열기 (서명 없음). |
